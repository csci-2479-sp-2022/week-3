...
2. clone this repo: `git clone git@github.com:csci-2479-sp-2022/weekly-examples.git`
3. go into the project: `cd weekly-examples`
...
7. Generate an app key for your `.env` file: `sail artisan key:generate`
